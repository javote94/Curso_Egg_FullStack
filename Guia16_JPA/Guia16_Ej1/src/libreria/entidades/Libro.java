...
//Consultas estáticas predefinidas de JPQL asociadas a una entidad (@NamedQuery)
@NamedQueries({
    @NamedQuery(name = "Libro.findByTitle", query = "SELECT l FROM Libro l WHERE l.titulo = :titulo"),
